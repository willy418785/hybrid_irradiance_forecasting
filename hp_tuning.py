...
class HyperTransformer(keras_tuner.HyperModel):
    ...
    def build(self, hp):
        ...
        if self.fine_tune:
            ...
            hp.Fixed("avg_window", 9, parent_name='is_using_stationary_module', parent_values=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-ft', '--finetune', type=bool, default=True, help='fine-tuning or not')
    parser.add_argument('-at', '--arch', type=bool, default=False, help='tuning network architecture or not')
    parser.add_argument('-tt', '--training', type=bool, default=False, help='tuning training parameters or not')
    parser.add_argument('--overwrite', type=bool, default=False, help='overwrite tuning history or not')
